    ...
    return(
        ...
        <div className="container">
            <Card title="Last Grove" 
                ...
                gameImage="https://github.com/dieguoin/dieguoin.github.io/tree/main/src/assets/LastGrove.png" gameAlt="game image"
            ...
            <Card title="Archer`s  Defense" 
                ...
                participationText="Mi principal aportación, puesto que es un proyecto propio, ha sido como programador de todo el juego." 
                gameImage="https://github.com/dieguoin/dieguoin.github.io/tree/main/src/assets/ArcherDefense.png" gameAlt="game image"
            ...
            <Card title="Lost Fragments" 
                ...
                gameImage="https://github.com/dieguoin/dieguoin.github.io/tree/main/src/assets/Robboticon.png" gameAlt="game image"
